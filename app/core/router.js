...
// Article Start
server.get(prefix +"/articles", controllers.article.showArticles)
server.post(prefix +"/articles", controllers.article.createArticle)
server.put(prefix +"/articles/:id", controllers.article.updateArticle)
server.del(prefix +"/articles/:id", controllers.article.deleteArticle)
